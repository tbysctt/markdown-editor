...
import { useEditorTabContext } from '../../contexts/EditorTabContext';
import { isUntitledPath } from '../../types/workspace';
import { ContextMenu, type ContextMenuItem } from '../ContextMenu';
import { ImagePathDialog } from '../dialogs/ImagePathDialog';
...
export function ImageView({
  ...
  const { docPath, resolveImageSrc, repairContext } = useEditorTabContext();
  ...
  }, [docPath, repairContext, updateAttributes]);
